...
export function LocalFactContent({ fact, monthly = false }: { fact: LocalFact; monthly?: boolean }) {
  ...
  return (
    <div className="min-w-0">
      ...
      {definition && <p className="mt-2 text-xs leading-5 text-[var(--muted)]">{definition.category}<br />{definition.evidence}</p>}
